...
require("lazy").setup({
	...
	--                parameter_hints = {
	--                    show = true,
	--                    prefix = '', -- Prefijo antes del tipo
	--                    suffix = '', -- Sufijo después del tipo
	--                },
	--                other_hints = {
	--                    show = true,
	--                    prefix = '',
	...
	--            },
	--        }
	--        -- Activa automáticamente con LSP
	...
	--},
	{
		...
		config = function()
			require("lsp_signature").setup({
				bind = true,
				hint_prefix = "💡 ", -- Prefijo para las pistas
				floating_window = true, -- Ventana flotante con ayuda
				handler_opts = {
		...
		config = function()
			...
			if vim.g.have_nerd_font then
				...
				vim.diagnostic.config({
					...
					virtual_text = {
						-- This is the text that shows up in the editor
						--  when you have a warning or error
						prefix = "●", -- Could be '●', '▎', 'x'
						spacing = 4,
					},
					underline = true,
...
require("lspconfig").clangd.setup({
	on_attach = function(clangd, bufnr)
		-- Activa el plugin lsp_signature
...
require("catppuccin").setup({
	custom_highlights = function(colors)
		return {
			---- You can use the colors from the theme and change the highlight groups, and set the best style for programming.
...
vim.cmd.colorscheme("catppuccin") -- Asegúrate de cargar el esquema
